  ...
  <div>
    ...
    <div class="warpper">
      <form id="formData" enctype="multipart/form-data">
        <p class="title">
          标题：
          <input type="text" name="title" :value="arr.weeklyTitle"/>
        </p>

        <p class="text_content">
          内容：
          <textarea name="content" :value="arr.weeklyContent"></textarea>
        </p>
      </form>

          <p style="color:grey;margin-top:50px;">*本年度的第{{week}}周</p>
    </div>
...
export default {
  ...
  created: function() {
    ...
    $.ajax({
      url: "https://huangfufu.top:8080/qiluweb/weekly/findweekly",
      type: "POST",
      data: {
        class_num: sef.$store.state.class_list[0]
      },
